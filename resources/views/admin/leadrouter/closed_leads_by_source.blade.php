                ...
                <div class="col-sm-12">
                    <div class="portlet light">
                        ...
                        <div class="portet-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <form action="{{url('admin/reporting/closed_leads')}}" method="get" class="form-inline">
                                        ...
                                        <div class="form-group">
                                            <a href="{{url('admin/reporting/closed_leads')}}" class="btn">Reset</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                               Closed Leads by source and type
                            </div>
                        </div>
                        <div class="portlet-body">
