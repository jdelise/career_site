...
<table class="body">
    <tr>
        <td class="center" align="center" valign="top">
            <!-- BEGIN: Header -->
            <table class="page-header" align="center" style="width: 100%">
                <tr>
                                                ...
                                                <table class="twelve columns">
                                                    <tr>
                                                        <td class="vertical-middle" style="padding-top: 0;padding-bottom: 0;vertical-align: middle;">
                                                            <a href="{{url('/')}}">
                                                                <img src="{{$message->embed(asset('frontend/images/logo.png'))}}" alt=""/>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                </table>
            ...
            <!-- END: Header -->
            <!-- BEGIN: Content -->
            <table class="container content" align="center" style="width: 580px;margin: 10px auto 0;text-align: inherit;">
                <tr>
                    <td>
                        @yield('content')
                    </td>
                                                ...
                                                <table class="four columns">
                                                    <tr>
                                                        <td class="vertical-middle" style="padding-top: 0;padding-bottom: 0;vertical-align: middle;color: #fff;">
                                                            &copy; CENTURY 21 Scheetz {{date('Y')}}.
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
