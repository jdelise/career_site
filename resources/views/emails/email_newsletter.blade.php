							...
							<td class="wrapper vertical-middle">
								...
								<tr>
									<td class="vertical-middle">
										<a href="index.html">
										<img src="<?php echo site_url('');?>images/logo_white.png" width="86" height="14" border="0" alt=""/>
										</a>
									</td>
								</tr>
								</table>
								...
								<tr>
									<td>
										...
										<tr>
											<td class="vertical-middle">
												<a href="#">
												<img src="<?php echo site_url('');?>admin_assets/assets/admin/pages/media/email/social_facebook.png" alt="social icon"/>
												</a>
											</td>
											<td class="vertical-middle">
												<a href="#">
												<img src="<?php echo site_url('');?>admin_assets/assets/admin/pages/media/email/social_twitter.png" alt="social icon"/>
												</a>
											</td>
											<td class="vertical-middle">
												<a href="#">
												<img src="<?php echo site_url('');?>admin_assets/assets/admin/pages/media/email/social_googleplus.png" alt="social icon"/>
												</a>
											</td>
											<td class="vertical-middle">
												<a href="#">
												<img src="<?php echo site_url('');?>admin_assets/assets/admin/pages/media/email/social_linkedin.png" alt="social icon"/>
												</a>
											</td>
											<td class="vertical-middle">
												<a href="#">
												<img src="<?php echo site_url('');?>admin_assets/assets/admin/pages/media/email/social_rss.png" alt="social icon"/>
												</a>
											</td>
										</tr>
										</table>
			...
			<td>
				...
				<tr>
					...
					<td class="wrapper last">
						...
						<tr>
							<td>
								<img src="<?php echo site_url('');?>admin_assets/assets/admin/pages/media/email/iphone.png" style="float:right; margin-right: 20px;" alt=""/>
							</td>
							<td class="expander">
							</td>
						</tr>
					...
					<td class="wrapper last">
						...
						<tr>
							<td>
								...
								<img src="<?php echo site_url('');?>admin_assets/assets/admin/pages/media/email/article.png" class="ie10-responsive" alt=""/>
							</td>
							<td class="expander">
							</td>
						</tr>
				...
				<tr>
					<td class="wrapper">
						...
						<tr>
							<td>
								<img src="<?php echo site_url('');?>admin_assets/assets/admin/pages/media/email/photo1.jpg" class="ie10-responsive" alt="photo">
								<h6>Product 1</h6>
								<p>
					...
					<td class="wrapper">
						...
						<tr>
							<td>
								<img src="<?php echo site_url('');?>admin_assets/assets/admin/pages/media/email/photo2.jpg" class="ie10-responsive" alt="photo">
								<h6>Product 2</h6>
								<p>
									 Lorem ipsum dolor sit amet, ut laoreet elit, sed diam.
								</p>
